...
<head>
  ...
  <style>
    ...
    * {
    ...
    .slide img {
      ...
      left: 0;
      width: 100%;
      height: auto; /* Change height to auto for responsive scaling */
      object-fit: cover;
      filter: brightness(60%); /* Adjust brightness of the background image */
    }
  ...
  nav ul li a:hover {
    color: #005b96; /* Change color on hover */
  }
...
<body>
  ...
  <header>
    <div class="container">
      <img src="images/nco_logo.png" alt="NCOU Logo" style="width: 150px; height: auto;">
      <h1>Welcome to NCOU Community</h1>
      <p>A place where we serve, empower, and thrive together.</p>
    </div>
  </header>
    ...
    <div class="slides">
      <div class="slide">
        ...
        <div class="slide-content">
          <h2>Welcome to NCOU Community</h2>
          <p>A place where we serve, empower, and thrive together.</p>
        </div>
      </div>
      <div class="slide">
      ...
      <div class="slide">
        <img src="images/img1.jpeg" alt="Slide 3">
        <div class="slide-content">
          <h2>Together, We Thrive</h2>
          <p>Together, we can achieve great things. Get involved today!</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="focus-area">
        <div class="focus-card">
          <div class="focus-icon">
            <img src="images/tea.png" alt="Your Icon" style="width: 50px; height: 50px;"></div>
          <div class="focus-description">
            <h3>Agri-business and Livelihood</h3>
            <p>Empowering communities through sustainable agriculture and livelihood projects.</p>
          </div>
        </div>
        <div class="focus-card">
            <div class="focus-icon">
                <img src="images/tea.png" alt="Your Icon" style="width: 50px; height: 50px;">
              </div>
          <div class="focus-description">
            <h3>Education and Skill Development</h3>
            <p>Providing educational opportunities and skill development programs for community members.</p>
          </div>
        </div>
        <div class="focus-card">
          <div class="focus-icon">
            <img src="images/education.png" alt="Your Icon" style="width: 50px; height: 50px;"></div>
          
          <div class="focus-description">
            <h3>Health and Wellness</h3>
            <p>Promoting health and wellness initiatives to improve the quality of life in our community.</p>
          </div>
        </div>
      </div>
